...
@pytest.mark.asyncio
async def test_tick_skips_processing_during_reload(
    cortex_runtime_with_mode_transition,
):
...
@pytest.mark.asyncio
async def test_tick_handles_llm_returning_none(
    cortex_runtime_with_mode_transition,
):
...
@pytest.mark.asyncio
async def test_tick_handles_fuser_returning_none(
    cortex_runtime_with_mode_transition,
):
...
@pytest.mark.asyncio
async def test_request_mode_change_integration(
    cortex_runtime_with_mode_transition,
):
...
@pytest.mark.asyncio
async def test_emergency_mode_has_highest_priority(
    cortex_runtime_with_mode_transition,
):
...
@pytest.mark.asyncio
async def test_no_mode_transition_input_continues_normal_processing(
    cortex_runtime,
):
...
@pytest.mark.asyncio
async def test_mode_transition_input_is_cleared_after_use_basic(
    cortex_runtime,
):
